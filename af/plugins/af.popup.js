    ...
    var popup = (function () {
        var popup = function (containerEl, opts) {
            ...
            try {
                ...
                this.id = opts.id || $.uuid(); //opts is passed by reference
                ...
                this.cancelText = opts.cancelText || "关闭";
        ...
        popup.prototype = {
            ...
            show: function () {
                ...
                var markup = "<div id='" + this.id + "' class='afPopup hidden "+ this.addCssClass + "'>"+
                            ...
                            "<div></div>"+
                            "<footer>"+
                                 '<img src="images/popupR.png"><img src="images/popupL.png">' +
                                 "<div><a href='javascript:;' class='" + this.cancelClass + "' id='cancel'>" + this.cancelText + "</a>"+
                                 "<a href='javascript:;' class='" + this.doneClass + "' id='action'>" + this.doneText + "</a>"+
                                 '<em></em>' + (this.cancelOnly ? "" : "<i></i>") + '</div>' +
                            "</footer>"+
                            "</div>";
                $(this.container).append($(markup));
                $("#" + this.id).children('div').append(this.message);
                $("#" + this.id).data("popupObj", this);
            ...
            positionPopup: function () {
                ...
                var _top = (window.innerHeight / 2.5) + window.pageYOffset - (popup[0].clientHeight / 2);
                _top = _top < 0 ? 0 : _top;
