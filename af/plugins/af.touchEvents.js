...
(function($) {
    "use strict";
    /*touch对象：x1、x2、y1、y2*/
    window.touch = {}; var touchTimeout;
    /*全局变量：isScrollLeft、isScrollRight、isScrollUp、isScrollDown*/
    window.isScrollLeft=window.isScrollRight=window.isScrollUp=window.isScrollDown=false;
